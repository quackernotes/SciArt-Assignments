...
11. Save the Results table in .csv format and the final image in .TIF format (name the files as per convenience and with enough detail so as to aid in future referencing/locating of the data.
